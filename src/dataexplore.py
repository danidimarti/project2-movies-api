...
def col_explore(dfcol):
    ...
    f'Values counts / total sum of values: {round((dfcol.value_counts()/dfcol.value_counts().sum())*100, 2)} \n',
    f'Describe column: {dfcol.describe()} \n'
     ) 
    
def testing(dfcol):
    print(f'Values counts / total sum of values: {round((dfcol.value_counts()/dfcol.value_counts().sum())*100, 2)} \n',
    f'Describe column: {dfcol.describe()} \n')
